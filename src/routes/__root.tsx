...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Salescode CMS" },
      { name: "description", content: "Salescode Generated Project" },
      { name: "author", content: "Salescode" },
      { property: "og:title", content: "Salescode CMS" },
      { property: "og:description", content: "Salescode Generated Project" },
